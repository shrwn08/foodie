...
dispatch(fetchCategoryProducts('dessert'))
  ...
  {
    isLoading.dessert && <p>Loading products...</p>;
  }
  {
  ...
  return (
    <div className="w-full h-full flex justify-center items-center flex-col gap-5 mt-5">
      <div className="w-5/6 h-full justify-center items-center flex flex-col">
        <p className="text-4xl font-bold text-black">Dessert Menu</p>
      ...
      <div className="w-5/6 h-full flex justify-center items-start flex-wrap gap-5">
        {categories.dessert &&
          categories.dessert.map((product) => (
            <div
